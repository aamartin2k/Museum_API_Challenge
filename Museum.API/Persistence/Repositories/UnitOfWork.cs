...
namespace MuseumAPI.Persistence.Repositories
{
    /*
        ...
        repositories, they share a single database context. That way, when a unit of work 
        is complete you can call the SaveChanges method on that instance of the context 
    ...
    */
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public async Task SaveChangesCompleteAsync()
        {
